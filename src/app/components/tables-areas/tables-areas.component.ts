...
export class TablesAreasComponent implements OnInit {
    ...
    getTotal1() {
        let total = 0;
        for ( let i = 0; i < this.tableData2.dataRows.length; i++ ) {
            const integer = parseInt(this.tableData2.dataRows[i].amount)
            total += integer;
        }
        return total;
    };
    getTotal2() {
        ...
        for ( let i = 0; i < this.tableData3.dataRows.length; i++ ) {
            const integer = parseInt(this.tableData3.dataRows[i][5])
            total += integer;
        }
        return total;
    };
